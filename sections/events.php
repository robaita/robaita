<section id="events">
    <div class="container">
      <div class="row">
        <div class="col-lg-7 mx-auto text-center mb-0">
          <h5 class="fw-light fs-3 fs-lg-5 lh-sm mb-3">Upcoming Workshops</h5>
                  ...
                  <div class="col-md-6 mb-4">
                    <div class="card h-100 shadow px-2 px-lg-3 card-span pt-4">
                      <div class="text-center text-md-start card-hover">
                        <div class="card-body">
                          <div class="d-flex align-items-center"><span class="badge bg-soft-primary text-primary fs--1 fw-light p-3 rounded-1"><span class="fw-medium fs-1 mb-2">23-25</span><br>July</span>
                            <h6 class="fw-light fs-1 fs-lg-2 text-start ms-3">Practical Machine Learning, an Online Workshop</h6>
                          </div>
                          <p class="mt-4 mb-md-0 mb-lg-3 fw-light lh-base text-start"> This is going to be the 3 day workshop. There, we would be covering the basic python and machine leanring. For more details about the course content, please click to the below link. </p>
                          <div class="d-flex flex-between-center">
                            <div class="d-flex align-items-center"><a class="btn btn-lg ps-0 text-primary fw-light fs--1" href="machine_leanring_workshop.php" role="button">Learn more
                            ...
                            <div class="d-flex align-items-center">
                              ...
                              <p class="mb-0 fw-light text-dark fs--1">03:00 PM - 06:00 PM IST</p>
                            </div>
                          </div>
                        </div>
                      </div>
